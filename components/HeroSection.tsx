  ...
  return (
    <section className="bg-hero-bg text-white relative overflow-hidden">
      ...
      <div className="bg-accent/95 text-white text-center py-2.5 text-sm font-medium tracking-wide">
        Free Engineering Consultation — Get Your Custom Quote Within 24 Hours
      </div>

      <div className="container-wide py-16 md:py-24">
        <div className="max-w-3xl">
          {/* Pain-point opener */}
          <div className="inline-flex items-center gap-2 bg-white/10 text-accent text-xs font-bold tracking-widest uppercase px-4 py-1.5 rounded-full mb-6">
            Stop Leakage · Reduce Downtime · Extend Equipment Life
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            Premium Carbon Graphite
            <br />
            <span className="text-accent">Sealing Solutions</span>
          </h1>
