...
const copy = {
    ...
    products: [
      {
        ...
        image: "/images/密封环/IMG_20260505_125818.jpg",
  ...
  vi: {
    ...
    products: [
      { title: "Vòng phớt than chì carbon", subtitle: "Mặt phớt cơ khí", description: "Cho bơm ly tâm, bơm hóa chất, bơm nước biển và phớt cơ khí thông dụng.", image: "/images/密封环/IMG_20260505_125818.jpg", href: "/products#seal-rings", icon: "seal" },
      { title: "Bạc lót / ổ trục graphite", subtitle: "Đỡ tự bôi trơn", description: "Tự bôi trơn, chống ăn mòn, dùng cho bơm chìm, hàng hải, máy khuấy và thiết bị quay tải nặng.", image: "/images/products/graphite-bushing.png", href: "/products#carbon-graphite-sleeves", icon: "gear" },
      { title: "Vòng chia than chì carbon", subtitle: "Vòng phân đoạn", description: "Phù hợp khoang kín, có thể bảo trì và thay thế mà không tháo trục.", image: "/images/products/three-part-ring.jpg", href: "/products#three-part-rings", icon: "shield" },
    ],
  },
  th: {
    ...
    products: [
      { title: "แหวนซีลคาร์บอนกราไฟต์", subtitle: "หน้าซีลกล", description: "สำหรับปั๊มหอยโข่ง ปั๊มเคมี ปั๊มน้ำทะเล และซีลกลทั่วไป", image: "/images/密封环/IMG_20260505_125818.jpg", href: "/products#seal-rings", icon: "seal" },
      { title: "บูช / แบริ่งกราไฟต์", subtitle: "รองรับแบบหล่อลื่นตัวเอง", description: "หล่อลื่นตัวเอง ทนกัดกร่อน ใช้กับปั๊มจุ่ม งานเรือ เครื่องกวน และอุปกรณ์หมุนหนัก", image: "/images/products/graphite-bushing.png", href: "/products#carbon-graphite-sleeves", icon: "gear" },
      { title: "แหวนแบ่งคาร์บอนกราไฟต์", subtitle: "วงแหวนแบ่งชิ้น", description: "เหมาะกับช่องปิด สามารถบำรุงรักษาและเปลี่ยนโดยไม่ต้องถอดเพลา", image: "/images/products/three-part-ring.jpg", href: "/products#three-part-rings", icon: "shield" },
    ],
  },
  ru: {
    ...
    products: [
      { title: "Углерод-графитовые кольца", subtitle: "Торцевые уплотнения", description: "Для центробежных, химических, морских насосов и стандартных механических уплотнений.", image: "/images/密封环/IMG_20260505_125818.jpg", href: "/products#seal-rings", icon: "seal" },
      { title: "Графитовые втулки / подшипники", subtitle: "Самосмазывающиеся опоры", description: "Для погружных насосов, морского оборудования, мешалок и тяжелых вращающихся узлов.", image: "/images/products/graphite-bushing.png", href: "/products#carbon-graphite-sleeves", icon: "gear" },
      { title: "Сегментные графитовые кольца", subtitle: "Разрезные кольца", description: "Для закрытых полостей, где обслуживание возможно без снятия вала.", image: "/images/products/three-part-ring.jpg", href: "/products#three-part-rings", icon: "shield" },
    ],
  },
  ja: {
    eyebrow: "製品能力",
    ...
    products: [
      { title: "カーボングラファイトシールリング", subtitle: "メカニカルシール面", description: "遠心ポンプ、化学ポンプ、海水ポンプ、一般メカニカルシール向け。", image: "/images/密封环/IMG_20260505_125818.jpg", href: "/products#seal-rings", icon: "seal" },
      { title: "グラファイトブッシング / 軸受", subtitle: "自己潤滑サポート", description: "水中ポンプ、船舶、撹拌機、重負荷回転機器向け。", image: "/images/products/graphite-bushing.png", href: "/products#carbon-graphite-sleeves", icon: "gear" },
      { title: "カーボングラファイト分割リング", subtitle: "分割シールリング", description: "軸を外さずに保守・交換が必要な密閉空間に適します。", image: "/images/products/three-part-ring.jpg", href: "/products#three-part-rings", icon: "shield" },
    ],
  },
  ko: {
    eyebrow: "제품 역량",
    ...
    products: [
      { title: "카본 그라파이트 씰 링", subtitle: "기계식 씰 페이스", description: "원심 펌프, 화학 펌프, 해수 펌프 및 일반 기계식 씰용.", image: "/images/密封环/IMG_20260505_125818.jpg", href: "/products#seal-rings", icon: "seal" },
      { title: "그라파이트 부싱 / 베어링", subtitle: "자체 윤활 지지부", description: "수중 펌프, 해양 장비, 교반기 및 중부하 회전 장비용.", image: "/images/products/graphite-bushing.png", href: "/products#carbon-graphite-sleeves", icon: "gear" },
      { title: "카본 그라파이트 분할 링", subtitle: "분할 씰 링", description: "축을 제거하지 않고 유지보수와 교체가 필요한 밀폐 공간에 적합.", image: "/images/products/three-part-ring.jpg", href: "/products#three-part-rings", icon: "shield" },
    ],
  },
}
