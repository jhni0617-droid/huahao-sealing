  ...
  return (
    <>
      ...
      >
        <Link
          href="/contact"
          className="flex items-center gap-2 bg-accent text-white px-5 py-3 rounded-lg shadow-lg font-semibold text-sm hover:bg-accent-hover transition-colors"
        >
        ...
        <a
          ...
          className="flex items-center gap-2 bg-green-600 text-white px-5 py-3 rounded-lg shadow-lg font-semibold text-sm hover:bg-green-700 transition-colors"
        >
      ...
      {/* Mobile bottom bar */}
      <div
        className={`md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-border shadow-xl transition-all duration-500 ${
