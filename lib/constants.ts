...
export const applications = [
  {
    ...
    slug: "pump-industry",
    description:
      "离心泵、化工泵、清水泵、污水泵、油泵及多级泵的旋转轴密封与轴套支撑。碳石墨密封环与轴套配合使用，自润滑免维护，显著降低轴磨损，延长泵组大修周期。广泛应用于工业水泵、城市供排水、石化流程泵及矿山渣浆泵等设备。",
    image: "pump",
  },
  {
    title: "船舶与海洋工程",
    ...
    description:
      "船舶螺旋桨艉轴密封、海水冷却泵密封、舵轴承、侧推器轴承及甲板机械轴承。特殊耐海水腐蚀浸渍工艺，确保在长期浸泡和干湿交替工况下保持尺寸稳定和低磨损。通过DNV等船级社认证，适用于各类商船、军舰及海洋平台。",
    image: "ship",
  },
  {
    title: "化工与制药",
    ...
    description:
      "化工反应釜搅拌轴密封、高压工艺泵密封、酸液输送泵轴套、制药机械搅拌器轴承。浸渍碳石墨具有优异的化学惰性，耐受强酸、强碱及有机溶剂腐蚀，同时满足FDA食品和药品接触要求，为严苛的化工和制药工艺提供可靠保障。",
    image: "chem",
  },
  {
    title: "电力与能源",
    slug: "power-energy",
    description:
      "电厂循环水泵轴承、核电站辅助泵密封、汽轮机润滑油泵轴套、热电联产供热泵密封。碳石墨耐高温特性（可达600°C）确保在高温蒸汽和热介质环境中长期稳定运行，减少计划外停机，提升发电设备可用率。",
    image: "seal",
  },
  {
    title: "食品与制药机械",
    slug: "food-pharma",
    description:
      "巧克力搅拌机轴承、食品输送泵密封、灌装机轴套、制药混合机密封件。食品级树脂浸渍碳石墨，完全无油自润滑运行，无金属污染风险，符合FDA和EU食品接触材料标准，满足HACCP食品安全管理体系要求。",
    image: "seal",
  },
  {
    title: "冶金与矿山",
    ...
    description:
      "矿山渣浆泵轴套、冶金轧机润滑系统密封、选矿设备搅拌轴承、除尘风机密封。碳石墨耐磨损和抗热冲击性能优异，在含固体颗粒介质和高粉尘恶劣环境中保持长寿命，降低频繁停机更换带来的维护成本。",
    image: "pump",
  },
  {
    title: "石油与天然气",
    slug: "oil-gas",
    description:
      "输油泵机械密封、天然气压缩机轴承、油田注水泵轴套、LNG低温泵密封。经过碳化和特殊浸渍处理的碳石墨牌号在油气介质中保持化学稳定性和尺寸精度，满足API标准要求，适用于陆地和海上油气田的严苛工况。",
    image: "chem",
  },
  {
    title: "通用工业密封",
    ...
    description:
      "阀杆密封、压缩机密封、搅拌器密封、风机轴承、造纸设备密封及各类特殊工业设备的定制工程密封方案。碳石墨材料灵活的可加工性使其能够适应各种非标结构和安装空间，为通用机械制造和OEM厂商提供经济可靠的密封与轴承解决方案。",
    image: "seal",
  },
]
...
export const applicationConditions = [
  ...
  {
    industry: "潜水泵及污水泵",
    tempRange: "0°C ~ 80°C（短期可达120°C）",
    pressureRange: "≤ 5 MPa",
    speedRange: "≤ 10 m/s",
    media: "清水、污水、泥浆、含颗粒介质",
    phRange: "5–10",
  },
  {
    industry: "空压机及气动设备",
