...
const gallery = [
  ...
  "/images/factory/cnc-turning-graphite.webp",
  "/images/factory/graphite-impregnation.webp",
  "/images/factory/qc-inspection-caliper.webp",
  "/images/factory/finished-rings-stack.webp",
  "/images/factory/packing-wooden-case.webp",
  "/images/factory/workshop-overview.webp",
]
...
const galleryLabels: Record<string, { zh: string; en: string }> = {
  ...
  "/images/factory/cnc-turning-graphite.webp": { zh: "数控车削石墨密封环", en: "CNC turning graphite seal ring" },
  "/images/factory/graphite-impregnation.webp": { zh: "石墨浸渍工序", en: "Graphite impregnation process" },
  "/images/factory/qc-inspection-caliper.webp": { zh: "游标卡尺检测密封环尺寸", en: "Caliper inspection of seal ring" },
  "/images/factory/finished-rings-stack.webp": { zh: "成品石墨密封环堆叠", en: "Finished graphite seal rings" },
  "/images/factory/packing-wooden-case.webp": { zh: "木箱包装发货", en: "Wooden case packing & shipment" },
  "/images/factory/workshop-overview.webp": { zh: "工厂车间全景", en: "Factory workshop overview" },
}
